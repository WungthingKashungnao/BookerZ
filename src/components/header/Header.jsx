...
const handleOption =(name, operation)=>{
  setOptions(prev=>{
    return {
      ...
      ...prev, [name]: operation === 'incre' ? options[name]+1 : options[name]-1
    }
  })
}
              ...
              <div className="options">
                ...
                <div className="optionItem">
                  ...
                  <div className="optionCounter">
                    <button disabled={options.adult<=1} className="optionCounterButton" onClick={()=>handleOption('adult', 'decre')} >-</button>
                    <span className="optionCounterNumber">{options.adult}</span>
                    <button className="optionCounterButton" onClick={()=>handleOption('adult', 'incre')}>+</button>
                  </div>
                </div>
                ...
                <div className="optionItem">
                  ...
                  <div className="optionCounter">
                    <button disabled={options.children<=0} className="optionCounterButton" onClick={()=>handleOption('children', 'decre')}>-</button>
                    <span className="optionCounterNumber">{options.children}</span>
                    <button className="optionCounterButton" onClick={()=>handleOption('children', 'incre')}>+</button>
                  </div>
                </div>
                ...
                <div className="optionItem">
                  ...
                  <div className="optionCounter">
                    <button disabled={options.room<=1} className="optionCounterButton" onClick={()=>handleOption('room', 'decre')}>-</button>
                    <span className="optionCounterNumber">{options.room}</span>
                    <button className="optionCounterButton" onClick={()=>handleOption('room', 'incre')}>+</button>
                  </div>
                </div>
